...
5. Architecture linting runs inside oxlint as a JS plugin with 12 rules, matching the behavior of the old script and adding a guard against raw entity serialization.
...
4. Write the oxlint plugin with all 12 rules.
